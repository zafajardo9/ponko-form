...
| `type` | `field_type` enum | `'text'`, `'email'`, `'number'`, `'textarea'`, `'select'`, `'checkbox'`, `'radio'`, `'payment'`, `'date'`, `'time'`, `'datetime'` |
...
| `field_type` | `'text'`, `'email'`, `'number'`, `'textarea'`, `'select'`, `'checkbox'`, `'radio'`, `'payment'`, `'date'`, `'time'`, `'datetime'` |
