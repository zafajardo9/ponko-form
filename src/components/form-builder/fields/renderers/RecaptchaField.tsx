...
export function RecaptchaField({ field, hideLabel }: Props) {
  ...
  return (
    <div className="flex min-w-0 flex-col gap-1.5">
      <fieldset className="flex min-w-0 flex-col gap-1.5">
        ...
        <div className="rounded-[var(--ponko-radius,6px)] border border-[#e6dfd8] bg-[#faf9f5] px-3.5 py-2.5 text-sm text-[var(--ponko-foreground-muted,#6c6a64)]">
