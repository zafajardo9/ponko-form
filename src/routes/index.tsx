...
const FEATURES = [
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path
          d="M10 2l1.8 5.4H18l-4.9 3.6 1.8 5.4L10 13l-4.9 3.4 1.8-5.4L2 7.4h6.2L10 2z"
          stroke="#cc785c"
          strokeWidth="1.5"
          strokeLinejoin="round"
        />
...
const STEPS = [
  ...
  },
  {
    ...
    description:
      "Drag text, email, dropdown, checkbox, and more onto your canvas.",
  },
  {
    number: "03",
    title: "Publish and share",
    description:
      "Hit publish and copy the link. Respondents can fill it in immediately.",
  },
  {
    number: "04",
  ...
  return (
    <div className="min-h-screen bg-[#faf9f5]">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20 pt-20 text-center">
        ...
        >
          Build forms that{" "}
          <em className="not-italic text-[#cc785c]">actually collect</em> what
          you need
        </h1>

        <p className="mx-auto mt-6 max-w-xl text-lg text-[#6c6a64]">
          Drag-and-drop form builder with a live preview, shareable links, and
          built-in payment collection via PayPal and Xendit. No code, no
          friction.
        </p>
        ...
        <p className="mt-4 text-sm text-[#8e8b82]">
          ...
          <div className="grid grid-cols-1 divide-x divide-[#e6dfd8] lg:grid-cols-3">
            ...
            <div className="hidden border-r border-[#e6dfd8] bg-[#faf9f5] p-4 lg:block">
              ...
              {[
                ...
                <div
                  key={t}
                  className="mb-1.5 flex items-center gap-2 rounded-lg border border-[#e6dfd8] bg-white px-3 py-2 text-sm text-[#141413]"
                >
            ...
            <div className="hidden bg-[#faf9f5] p-4 lg:block">
              ...
              <div className="mb-3">
                <p className="mb-1 text-xs font-medium text-[#141413]">
                  Placeholder
                </p>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((f) => (
              ...
              >
                ...
                <h3 className="mb-2 text-base font-medium text-[#141413]">
                  {f.title}
                </h3>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-16 text-center">
            ...
            <p className="mt-4 text-[#6c6a64]">
              Four steps from zero to collecting responses.
            </p>
          </div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mb-8 text-[#a09d96]">
                Enable payments on any form and choose between PayPal or Xendit.
                Respondents are redirected to the payment flow, then back to
                your thank-you page. Every transaction is logged with full
                status tracking.
              </p>
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-3 rounded-xl border border-[#252320] bg-[#252320] px-4 py-3">
                  <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#003087] text-xs font-bold text-white">
                    PP
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3 rounded-xl border border-[#252320] bg-[#252320] px-4 py-3">
                  <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#0e6baf] text-xs font-bold text-white">
                    X
                  </div>
                  <div>
            ...
            <div className="rounded-2xl border border-[#252320] bg-[#1f1e1b] p-6">
              <div className="mb-1 text-xs font-medium text-[#a09d96]">
                Payment
              </div>
              <div className="mb-4 text-2xl font-semibold text-[#faf9f5]">
                $49.00 USD
              </div>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`rounded-full px-2 py-0.5 text-xs ${tx.status === "paid" ? "bg-green-900/50 text-green-400" : "bg-amber-900/50 text-amber-400"}`}
                      >
                        {tx.status}
                      </span>
      ...
      <footer className="border-t border-[#e6dfd8] bg-[#faf9f5] py-10">
        <div className="mx-auto max-w-6xl px-6 flex flex-col items-center justify-between gap-4 sm:flex-row">
          <div className="flex items-center gap-2 text-sm font-semibold text-[#141413]">
            <span className="flex h-6 w-6 items-center justify-center rounded bg-[#cc785c] text-xs font-bold text-white">
              P
            </span>
            PonkoForm
          </div>
