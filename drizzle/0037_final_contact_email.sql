ALTER TABLE "form_pages" ADD COLUMN IF NOT EXISTS "final_contact_email" varchar(254);
--> statement-breakpoint
-- The atomic page-form save function is recreated so the final page's optional
-- support email survives a full save/replace cycle.
